  ...
  return (
    ...
    >
      ...
      <div className="space-y-24 mt-20">
        ...
        {sections.map(([title, list], sectionIdx) => (
                ...
                >
                  ...
                  <div className="relative z-10 p-7">
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <ArrowUpRight className="w-6 h-6 text-cyan-400 opacity-0 transition-all duration-300 group-hover:opacity-100 group-hover:-translate-y-1 group-hover:translate-x-1" />
                    ...
                    <p className="mt-4 text-slate-300 leading-relaxed text-sm">
                      ...
                      {project.description ||
                        'Modern production-grade implementation with optimized performance, scalable architecture, and premium user experience.'}
                    ...
                    <div className="flex gap-4 mt-7">
                      ...
                      <motion.a
                        ...
                        className="group/button flex items-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-5 py-3 text-sm font-medium text-white transition-all duration-300 hover:border-cyan-400/30 hover:bg-cyan-500/10"
                      >
                      ...
                      <motion.a
                        ...
                        className="group/button flex items-center gap-2 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-cyan-500/20 transition-all duration-300 hover:shadow-cyan-500/40"
                      >
